...
"""
from init_prompt import ETHOS_INITIAL_PROMPT

# 数据配置
DATA_CONFIG = {
    'task_name': 'ethos',
    'data_dir': 'D:\研究生\espai\mapgd\data\ethos',
...
MAPGD_CONFIG = {
    ...
    # GPU加速配置
    'use_gpu': True,
    'batch_size': 32,  # SentenceTransformer批量处理大小
...
EXPERIMENT_CONFIG = {
    **DATA_CONFIG,
    **MAPGD_CONFIG,
    'initial_prompt': ETHOS_INITIAL_PROMPT
}
